...
import { uploadImagenMiddleware } from '../middlewares/upload.middleware';
...
router.post('/upload-imagen', authenticate, requireRole('SUPER_ADMIN', 'ADMIN', 'MANAGER'), uploadImagenMiddleware, ProductoController.uploadImagen); // Admin - Upload
